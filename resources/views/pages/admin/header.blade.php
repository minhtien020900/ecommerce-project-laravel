<div class="app-header header-search-icon">
    <div class="header-style1">
        <a class="header-brand" href="index.html">
            ...
            />
            <img
                src="{{asset('images/brand/logo-1.png')}}"
        ...
        <a class="header-brand header-brand1" href="index.html">
            <img
                src="{{asset('images/brand/logo-white.png')}}"
                class="header-brand-img desktop-logo"
                alt="logo"
            />
            <img
    ...
    <div class="app-sidebar__toggle" data-toggle="sidebar">
        ...
        ><i class="fe fe-align-left"></i
            ></a>
        <a class="close-toggle" href="#"><i class="fe fe-x"></i
            ></a>
    </div>
    <div class="d-flex ml-auto header-right-icons">
        ...
        <div class="dropdown d-md-flex message">
            ...
            >
                ...
                <span
                    class="nav-unread badge badge-danger badge-pill"
                >3</span
                >
            </a>
            <div
            ...
            >
                <div class="message-menu">
                    ...
                    >
                        ...
                        cover-image
                      "
                                            data-image-src="{{asset('images/users/1.jpg')}}"
                                        ></span>
                        <div>
                    ...
                    <a class="dropdown-item d-flex pb-3" href="#">
                        ...
                        align-self-center
                        cover-image
                      " data-image-src="{{asset('images/users/12.jpg')}}"></span>
                        <div>
                    ...
                    <a class="dropdown-item d-flex pb-3" href="#">
                        ...
                        align-self-center
                        cover-image
                      " data-image-src="{{asset('images/users/4.jpg')}}"></span>
                        <div>
                    ...
                    <a class="dropdown-item d-flex pb-3" href="#">
                        ...
                        align-self-center
                        cover-image
                      " data-image-src="{{asset('images/users/15.jpg')}}"></span>
                        <div>
        ...
        <div class="dropdown profile-1">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                ...
                <a class="dropdown-item" href="#">
                    <i
                        class="dropdown-icon mdi mdi-account-outline"
                    ></i>
                    Profile
                </a>
                <a class="dropdown-item" href="#">
                    <i
                        class="dropdown-icon mdi mdi-settings"
                    ></i>
                    Settings
                </a>
                <a class="dropdown-item" href="#">
                    ...
                    <i
                        class="dropdown-icon mdi mdi-message-outline"
                    ></i>
                    Inbox
                </a>
                <a class="dropdown-item" href="#">
                ...
                <a class="dropdown-item" href="#">
                    <i
                        class="dropdown-icon mdi mdi-compass-outline"
                    ></i>
                    Need help?
                </a>
                <a class="dropdown-item" href="login.html">
                    <i
                        class="dropdown-icon mdi mdi-logout-variant"
                    ></i>
                    Sign out
                </a>
            </div>
